...
import BakeryBackground from "./BakeryBackground";
    ...
    return (
        <section className="py-16 md:py-32 px-6 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-10 md:mb-20 text-brand-olive-dark">
                    <span className="text-brand-gold-bright text-[10px] font-black uppercase tracking-[0.4em] mb-4 block">Trust & Partnerships</span>
                    <h2 className="text-3xl sm:text-5xl md:text-6xl font-serif font-black mb-6 tracking-tight">Partner <span className="text-brand-gold-bright italic text-4xl sm:text-6xl md:text-7xl">Voices</span></h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {VVIP_BAKERY.testimonials.map((t, idx) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-brand-soft-gray/50 backdrop-blur-sm p-6 sm:p-10 rounded-[2rem] sm:rounded-[3rem] border border-gray-100 hover:border-brand-gold-bright/30 transition-all duration-500 hover:shadow-2xl group flex flex-col justify-between"
                        >
                            <div>
                                ...
                                <p className="text-gray-500 text-base sm:text-lg md:text-xl font-serif italic mb-8 leading-relaxed">
                                    &quot;{t.review}&quot;
                                </p>
                            </div>
