    ...
    return (
        <section className="py-32 px-6 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-20 text-brand-olive-dark">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {VVIP_BAKERY.testimonials.map((t, idx) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-brand-soft-gray/50 backdrop-blur-sm p-10 rounded-[3rem] border border-gray-100 hover:border-brand-gold-bright/30 transition-all duration-500 hover:shadow-2xl group"
                        >
